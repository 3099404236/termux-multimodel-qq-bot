...
TOOL_CALL_PROMPT = (
    ...
    "do not send standalone progress updates such as 'I'm checking' or '正在查资料' before calling a tool; "
    "follow the tool schema exactly and do not invent parameters; "
    "wait for the tool result and then answer the user; "
...
TOOL_CALL_PROMPT_SKILLS_LIKE_MODE = (
    ...
    " Wait for the tool result, then answer the user based on that result."
