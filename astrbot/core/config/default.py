            ...
            "provider_ltm_settings": {
                ...
                "items": {
                    ...
                    "group_memory": {
                        ...
                        "items": {
                            "enable": {"type": "bool"},
                            "recent_messages": {"type": "int"},
                            "summary_batch_size": {"type": "int"},
                            "summary_count": {"type": "int"},
                            "quiet_seconds": {"type": "int"},
                            "compress_provider_id": {"type": "string"},
                        },
                    },
                    "active_reply": {
                        "type": "object",
                        "items": {
                            ...
                            "method": {
                                "type": "string",
                                "options": ["rule_based_reply", "possibility_reply"],
                            },
                            "possibility_reply": {
                                "type": "float",
                            },
        ...
        "metadata": {
            ...
            "ltm": {
                ...
                "items": {
                    ...
                    "provider_ltm_settings.group_memory.enable": {
                        "description": "启用持久化分层群聊记忆",
                        "type": "bool",
                        "hint": "保存群聊原文，分批生成结构化摘要，并允许模型按需搜索历史。",
                    },
                    "provider_ltm_settings.group_memory.recent_messages": {
                        "description": "至少保留的最近原文数",
                        "type": "int",
                        "condition": {
                            "provider_ltm_settings.group_memory.enable": True,
                        },
                    },
                    "provider_ltm_settings.group_memory.summary_batch_size": {
                        "description": "每批压缩消息数",
                        "type": "int",
                        "hint": "达到该数量并且群聊安静一段时间后生成一份不可变事件摘要。",
                        "condition": {
                            "provider_ltm_settings.group_memory.enable": True,
                        },
                    },
                    "provider_ltm_settings.group_memory.summary_count": {
                        "description": "注入最近事件摘要数",
                        "type": "int",
                        "condition": {
                            "provider_ltm_settings.group_memory.enable": True,
                        },
                    },
                    "provider_ltm_settings.group_memory.quiet_seconds": {
                        "description": "安静多久后执行压缩（秒）",
                        "type": "int",
                        "condition": {
                            "provider_ltm_settings.group_memory.enable": True,
                        },
                    },
                    "provider_ltm_settings.group_memory.compress_provider_id": {
                        "description": "群聊压缩模型",
                        "type": "string",
                        "_special": "select_provider",
                        "hint": "留空时使用当前聊天模型。压缩在群聊安静后后台执行。",
                        "condition": {
                            "provider_ltm_settings.group_memory.enable": True,
                        },
                    },
                    ...
                    "provider_ltm_settings.active_reply.method": {
                        ...
                        "type": "string",
                        "options": ["rule_based_reply", "possibility_reply"],
                        "hint": "推荐使用 rule_based_reply，仅在消息像是在对机器人发问或承接机器人刚才的话题时触发。",
                        "condition": {
